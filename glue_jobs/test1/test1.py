...
args = getResolvedOptions(sys.argv, [
    ...
    'glueDatabase',
    'glueTables',
    'partition_values_wqt'])

env = args['env']

#appsync_api_id = ssm.get_parameter(Name=f"/DataQuality/{env}/AppSync/GraphQLApi")['Parameter']['Value']

suggestion_dynamodb_table_name = f"mra-esg-deequ-suggestion-"+env
analysis_dynamodb_table_name = f"mra-esg-deequ-analyzer-"+env
...
partition_values = args['partition_values_wqt']
